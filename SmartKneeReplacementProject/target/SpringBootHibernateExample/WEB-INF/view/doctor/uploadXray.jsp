                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <label class="btn btn-default file-upload-btn">
                        Choose file...
                        <input id="form-control-22" class="file-upload-input" type="file" name="file" required>
                      </label>
                    </div>
                  </div>        
                  <%-- <div class="form-group">
                    ...
                    <label class="custom-control custom-control-primary custom-checkbox active">
                      <f:input path= class="custom-control-input" type="checkbox" name="check" required="required"/>
                      <span class="custom-control-indicator"></span>
