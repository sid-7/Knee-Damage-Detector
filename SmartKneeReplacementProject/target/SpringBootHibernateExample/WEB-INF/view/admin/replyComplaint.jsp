...
<form:form action="updateComplaint" method="post" modelAttribute="complaintedit">
ComplaintTitle:<form:input type ="text" path="complaintTitle"/>
ComplaintDescription:<form:input type ="text" path="complaintDescription"/>
ComplaintReplyDescription:<form:input type ="text" path="complaintReplyDescription"/>
      ...
      <div class="site-content">
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="m-y-0">Post Complaint</h3>
          </div>
          <div class="panel-body">
            <div class="row">
              ...
              <!-- DOCTOR FORM -->
                <form:form data-toggle="validator" action="updateComplaint" modelAttribute="complaintedit" method="post">
                  <div class="form-group">
                    <label for="form-control-1" class="control-label">Complaint Title</label>
                    <div class="input-group">                      
                      <form:input path="complaintTitle" type="text" maxlength="15" class="form-control" id="form-control-1"/>
                    </div>
                    <div class="help-block with-errors"></div>
                  </div>
                  <div class="form-group">
                    <label for="form-control-2" class="control-label">Complaint</label>
                    <form:textarea path="complaintDescription" id="form-control-2" class="form-control" rows="5"/>
                  </div>                  
                  <div class="form-group">
                    <label for="form-control-2" class="control-label">ComplaintReplyDescription</label>
                    <form:textarea path="complaintReplyDescription" id="form-control-2" class="form-control" rows="2"/>
                  </div>
                  <form:hidden path="complaintId"/>     
