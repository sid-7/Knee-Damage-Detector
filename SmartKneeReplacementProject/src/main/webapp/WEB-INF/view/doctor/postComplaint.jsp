        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="row">
              ...
              <!-- DOCTOR FORM -->
                <form:form data-toggle="validator" action="insertComplaint" modelAttribute="complaintadd" method="post">
                  <div class="form-group">
                    <label for="form-control-1" class="control-label">Complaint Title</label>
                    <div class="input-group">                      
                      <form:input path="complaintTitle" type="text" maxlength="15" class="form-control" id="form-control-1"  data-error="This field is required." required="required"/>
                    </div>
                    <div class="help-block with-errors"></div>
                  </div>
                  <div class="form-group">
                    <label for="form-control-2" class="control-label">Complaint</label>
                    <form:textarea path="complaintDescription" id="form-control-2" class="form-control" rows="5" data-error="This field is required." required="required"/>
                    <div class="help-block with-errors">Write about your complaint</div>
                  </div>                  
