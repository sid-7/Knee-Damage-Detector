...
<html lang="en">
  <head>
    ...
    <title>Cosmos</title>
    <link rel="icon" type="image/png" href="adminResources/images/favicon-32x32.png" sizes="32x32">
  ...
  <body class="layout layout-header-fixed layout-left-sidebar-fixed">
    ...
    <div class="site-main">
      ...
      <div class="site-content">
        ...
        <div class="panel panel-default panel-table">
          <div class="panel-heading">
            <h3 class="m-t-0 m-b-5">Export Functions</h3>
          </div>
          <div class="panel-body">
            <div class="table-responsive">
    ...
    <script src="adminResources/js/tables-datatables.min.js"></script>
  </body>
</html>