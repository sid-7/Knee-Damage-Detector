      ...
      <div class="site-content">
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="m-y-0">Edit Package</h3>
          </div>
          <div class="panel-body">
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <f:form data-toggle="validator" action="updatepackage" modelAttribute="packageedit" method="post">
                  
                  <f:hidden path="id"/>
                  <div class="form-group">
                    <label for="form-control-1" class="control-label">Package Name</label>
                    <div class="input-group">                      
                      <f:input path="packageName" type="text" pattern="^[_A-z0-9]{1,}$" maxlength="15" class="form-control" id="form-control-1" placeholder="Package name" data-error="This field is required." required="required"/>
                    </div>
                    <div class="help-block with-errors"></div>
                  </div>                  
                  <div class="form-group">
                    <label for="form-control-2" class="control-label">Package Description</label>
                    <f:textarea path="packageDescription" id="form-control-2" class="form-control" rows="3" data-error="This field is required." required="required"/>
                    <div class="help-block with-errors">What does this package include?</div>
                  </div>                  
                  <div class="form-group">
                    <label for="form-control-3" class="control-label">Package Amount</label>
                    <div class="input-group">
                      <f:input path="packageAmount" type="text" pattern="^[_0-9]{1,}$" maxlength="15" class="form-control" id="form-control-3" placeholder="packageAmount" data-error="This field is required." required="required"/>
                    </div>
                    <div class="help-block with-errors"></div>
                  </div>                  
                  <button type="submit" class="btn btn-primary btn-block" value="submit" name="submit">Add</button>
                </f:form>
              </div>
            </div>         
          </div>
