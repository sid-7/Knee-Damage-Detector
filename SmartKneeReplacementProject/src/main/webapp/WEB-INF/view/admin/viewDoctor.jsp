      ...
      <div class="site-content">
        <div class="panel panel-default panel-table m-b-0">
          <div class="panel-heading">
            <h3 class="m-t-0 m-b-5">Doctors</h3>
          </div>
              ...
              <table class="table table-striped table-bordered dataTable" id="table-3">
                ...
                <c:forEach items="${key}" var="x">
                  <tr>
                    <td>${x.id}</td>
                    <td>${x.firstName}</td>
                    <td>${x.lastDescription}</td>
                    <td>${x.eMail}</td>
                    <td>${x.contactNo}</td>
                    <td>${x.gender}</td>
                    <td>${x.qualificaton}</td>
                    <td>${x.practiceNo}</td>
                    <td>${x.clinicName}</td>
                    <td>${x.clinicAddress}</td>
                    <td><a href="deleteDoctor?id=${x.id}">Delete</a></td>
              	    <td><a href="editDoctor?id=${x.id}">Edit</a></td>       
                  </tr>
                 </c:forEach>
                </tbody>
                <tfoot>
