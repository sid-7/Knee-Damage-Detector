              ...
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form data-toggle="validator">
                  <div class="form-group">
                    <label for="form-control-2" class="control-label">Complaint Tab</label>
                    <input type="email" class="form-control" id="form-control-2" placeholder="Complaint"  required>
                    <div class="help-block with-errors"></div>
                  </div>
                  
                  <div class="form-group">
                    <label for="form-control-4" class="control-label">Complaint description </label>
