      ...
      <div class="site-content">
        <div class="panel panel-default panel-table">
          <div class="panel-heading">
            <h3 class="m-t-0 m-b-5">Dataset</h3>
          </div>
            ...
            <div class="table-responsive">
              <table class="table table-striped table-bordered dataTable" id="table-2">
                ...
                <tbody>
                  ...
                  <c:forEach items="${datasetList}" var="x" >
                  <tr>
                    <td>${x.datasetId}</td>
                    <td>${x.datasetName}</td>
                    <td><a href="<%=request.getContextPath()%>/document/demo/${x.datasetName}" target="_blank">view</a></td>
                    <td><a href="deleteDataset?id=${x.datasetId}">delete</a></td>
                  </tr>
                  </c:forEach>
                </tbody>
                <tfoot>
