      ...
      <div class="site-content">
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="m-y-0">Purchase Package</h3>
          </div>
              ...
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">               
                <form class="form-horizontal" data-toggle="validator">                                  
                  <div class="form-group">
                    <label for="form-control-1" class="col-sm-3 control-label">Choose Package</label>
                    <div class="col-sm-6">
	                  <select id="form-control-1" class="custom-select" data-error="This field is required." required>
                  ...
                  <div class="form-group">
                    <label for="form-control-2" class="col-sm-3 control-label">Card number</label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="form-control-2" placeholder="Card number">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="form-control-3" class="col-sm-3 control-label">Type</label>
                    <div class="col-sm-6">
