			...
			<div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="position-relative m-mb-20">
                                            ...
                                            <select class="js-example-basic-single fz-poppins" name="state">
                                    ...
                                    <div class="col-md-6">
                                        <div class="position-relative m-mb-20">
                                            ...
                                            <select class="js-example-basic-single fz-poppins" name="state">
                                                ...
                                                <option value="Department1">Doctort1</option>
                                                <option value="Department1">Doctor2</option>
                                                <option value="Department1">Doctor3</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
				...
				<div class="col-md-4">
					<div class="bg-white pt-4 pl-4 pb-4 pr-4 info-box m-mb-30  radius-5">
						<h5 class="m-text-2 mb-3">Vishwakarma Government Engineering College</h5>
							<div class="media ">
...
Bend, IN 360001</p>
					...
					<div class="bg-white pt-4 pl-4 pb-4 pr-4 info-box m-mtb-20  radius-5">
						<h5 class="m-text-2 mb-3">E-mail & Fax</h5>
							<div class="media ">
							    <div class="media-body">
							        <p class="m-0  fz-poppins">E-mail: help@ghutknee.com</p>
