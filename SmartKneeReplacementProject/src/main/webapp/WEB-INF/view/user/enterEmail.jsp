			...
			<div class="row">
				<div class="col-md-8">
					<div class="appoint-card border-light type-3 radius-20 bg-white  position-relative m-pt-50 m-pb-50 ">
						<div class="row">
							<div class="col-md-12">
								<h3 class="m-text-2 pb-35 mb-0">Please Enter Your Email Before Uploading Xray:</h3>
							</div>
						</div>
					<form action="/user/userOTP" method="post" enctype="multipart/form-data">	
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type="text" name="email" class="form-control fz-poppins m-mb-20" placeholder="Enter your E-Mail:"/>
                                    </div>
                                </div>
                                <div class="row">
				...
				<div class="col-md-4">
					<div class="bg-white pt-4 pl-4 pb-4 pr-4 info-box m-mb-30  radius-5">
						<h5 class="m-text-2 mb-3">Ahmedabad</h5>
							<div class="media ">
							    <div class="media-body">
							        <p class="m-0  fz-poppins">Call 24/7</p>
					...
					<div class="bg-white pt-4 pl-4 pb-4 pr-4 info-box m-mb-30  radius-5">
						<h5 class="m-text-2 mb-3">Our Address</h5>
							<div class="media ">
							    <div class="media-body">
							        <p class="m-0  fz-poppins">Vishwakarma Government Engineering College, Chandkheda, 380005</p>
							    </div>
							</div>
					</div> <!-- col-->
					<div class="bg-white pt-4 pl-4 pb-4 pr-4 info-box m-mtb-20  radius-5">
						<h5 class="m-text-2 mb-3">Email & Fax</h5>
							<div class="media ">
							    <div class="media-body">
							        <p class="m-0  fz-poppins">Email: help@GhutKnee.com</p>
							        <p class="m-0  fz-poppins">Fax: +91 23 755 755</p>
							    </div>
							</div>
					</div> <!-- col-->
				</div>
